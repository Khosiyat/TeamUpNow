...
class EditProfileForm(forms.ModelForm):
	...
	first_name = forms.CharField(widget=forms.TextInput(attrs={'class': 'input is-small'}), label="Old password",max_length=50,  required=True)
	last_name = forms.CharField(widget=forms.TextInput(attrs={'class': 'input is-small'}), label="Old password",max_length=50,  required=True)
	location = forms.CharField(widget=forms.TextInput(attrs={'class': 'input is-small'}), label="Old password",max_length=25,  required=True)
	githubProfile = forms.URLField(widget=forms.TextInput(attrs={'class': 'input is-small'}), label="Old password",max_length=50,  required=True)
	linkedInnProfile = forms.URLField(widget=forms.TextInput(attrs={'class': 'input is-small'}), label="Old password",max_length=50,  required=True)
	interstCategory = forms.ChoiceField(widget=forms.Select(attrs={'class': 'input is-small'}), choices=CLASS_CATEGORY, label="Old password", required=False, initial='classCategory')
