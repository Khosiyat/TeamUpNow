...
SECRET_KEY = 'django-insecure-2$sl8ra0+6(5mf83l$1lc#@icvs#)=jrg_g7w6g%t8$vyk25ie'
...
ALLOWED_HOSTS = ['18.232.82.192', 'localhost', 'teamupnow.tech', 'www.teamupnow.tech', '52.4.59.231', '3.84.109.179']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'TeamUpNow/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
